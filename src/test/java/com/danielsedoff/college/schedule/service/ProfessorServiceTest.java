...
class ProfessorServiceTest {
    ...
    @Test
    void testUpdateProfessor() throws ProfessorDAOException {
        int profId = 1;
    ...
    @Test
    void testCreateProfessor() throws ProfessorDAOException {
    ...
    @Test
    void testDeleteProfessor() throws ProfessorDAOException {
    ...
    @Test
    void testGetProfessorById() throws ProfessorDAOException {
        Professor professor = new Professor();
    ...
    @Test
    void testGetProfessorIdList() throws ProfessorDAOException {
